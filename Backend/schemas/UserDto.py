...
class UserDto:
    ...
    user = api.model("user", {
        ...
        "cellphone": fields.String(example="99999999999", required=True, description="User's cellphone"),
        "cpf": fields.String(example="99999999999", required=True, description="User's cpf"),
    ...
    user_put = api.model("user_put", {
        "id": fields.String(example="06018407-c3e9-4a2a-a381-b4b70cce2b1e", required=True, description="user UUID"),
        "name": fields.String(example="User", required=False, description="User's last name"),
        "email": fields.String(example="user", required=False, description="User's e-mail"),
        ...
        "status": fields.String(example="ACTIVE", required=False, description="User's status"),
    })