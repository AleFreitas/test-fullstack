...
const ClientDashboard: React.FC = () => {
  ...
  useEffect(() => {
    if (data) {
      if (isSuccess) {
        toast.success('Clientes obtidos com sucesso', {
          toastId: 'get-clients-success',
          autoClose: 2000,
        });
      }
  ...
  return (
    ...
    >
          ...
          <>
            {isSuccess &&
              (clients.length === 0 ? (
                <Box
                  className={
                    'flex w-full h-[500px] items-center justify-center'
                  }
                >
                  <Typography sx={{ color: '#949494', fontSize: '15px' }}>
            ...
            {isError && (
              <Box
                className={'flex w-full h-[500px] items-center justify-center'}
              >
                <Typography sx={{ color: '#949494', fontSize: '15px' }}>
      ...
      <Typography
        sx={{ color: '#949494', fontSize: '15px', marginTop: '10px' }}
      >
